...
Next, download the [swift and grpc-swift protoc plugins](https://github.com/grpc/grpc-swift/releases/download/1.4.0/protoc-grpc-swift-plugins-1.4.0.zip). Unarchive the downloaded file and move the binaries from the `bin/` directory to somewhere in your `$PATH`.
...
```swift
dependencies: [
  .package(url: "https://github.com/vyshane/grpc-swift-combine.git", from: "1.0.6"),
],
```
